...
export default function About(props) {
  return (
    <>
    <div className="container border border-dark p-4 my-4" style={{backgroundColor: props.mode === 'dark'?'grey':'white', color: props.mode === 'dark'?'white':'black'}}>

    <h1>What is WordCount?</h1>
